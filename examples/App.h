...
private:
    ...
    void BuildCards();       // brief 32: Card (4 estilos × estática/clicable/seleccionable) + one-shots
    void BuildExtraWidgets(); // galería de widgets antes sin probar (Drag*, pickers, plots, etc.)
    void BuildTextSharpnessLab(); // brief 29: laboratorio A/B de nitidez de texto (bitmap hinted vs MSDF+Fase E)
    ...
    int m_extraTab = 0;
    std::vector<std::string> m_extraTabLabels;
