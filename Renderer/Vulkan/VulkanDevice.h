// Renderer/Vulkan/VulkanDevice.h — GPU física + device lógico + colas.
// Diseño: Fase 1. Vulkan 1.3 con dynamic rendering + synchronization2 (el resto
// de features, como bindless, se añaden cuando una fase los pida).
#pragma once
