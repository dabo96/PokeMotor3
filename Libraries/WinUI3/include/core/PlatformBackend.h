...
#include "core/SystemColors.h" // brief 34 Parte F
#include <cstdint>
#include <memory>
#include <string>
...
public:
  ...
  // ── System colors (brief 34 Parte F). Paleta del SO para HighContrast, con
  //    fallback fuera de Windows. No es pura: las implementaciones existentes
  //    (SDLPlatform / NullPlatform) heredan esta consulta sin cambios. ──
  virtual SystemColors GetSystemColors() { return SystemColors::Query(); }
};
